                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            ...
                            <div class="border bg-light p-3 px-3 rounded mb-3">
                                <h5 class="d-flex align-items-center justify-content-between mb-3"
                                    ...
                                    <button id="facilities_btn" onclick="facility_clear()" class="shadow-none btn btn-sm text-seondary d-none">Reset</button>
                                </h5>
                                <?php
                            ...
                            <div class="border bg-light p-3 px-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        ...
                                        <input type="number" min="1" id="adults" value="<?php echo $adult_default ?>" oninput="guests_filter()"
